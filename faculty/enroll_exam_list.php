...
?>
<a class="btn btn-success btn-sm" href="?allowExam=<?php echo $value['id']; ?>">Accept</a>
<a class="btn btn-danger btn-sm" href="?reject=<?php echo $value['id']; ?>">Reject</a>
<?php  }else if($value['enrolled_status']==1){

echo '<button class="btn btn-success btn-sm"  disabled>Accepted</button>';    
}else{
