...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $message = $exam->udpateExam($examId, $exam_title, $total_qsns, $exam_duration, $total_marks, $exam_declaration_datetime, $exam_status, $solution);
}
                        ...
                        <form class="row g-3 form-group" action="" method="POST" enctype="multipart/form-data">
                            ...
                            ?>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea name="total_qsns" id="" cols="30" rows="5" class="form-control" id="total_qsns"><?php echo $value['total_qsns']; ?></textarea>
                                    </div>
                                    <div class="col-12">
                                        <label for="solution" class="form-label">Solution</label>
                                        <textarea name="solution" id="" cols="30" rows="5" class="form-control" id="solution"><?php echo $value['solution']; ?></textarea>
                                    </div>
                                    <div class="col-12">
