    ...
    public function examEnrollRequest($examId, $studentId)
    {
       ...
       public function getExamById($examId)
       {
           ...
           return $result;
            ...
            // Submit exam
            public function preSubmitEnrolledExamCheck($std_id,$examId, $submitexam , $std_ans)
            {
                ...
                if($timeover == 1 || $submitted==1){
                    ...
                    if($examduration*60 >= $seconds){
                        if($submitexam ==1){
                            ...
                            $updateQuery = "UPDATE `std_solution` SET  `std_ans`='$std_ans'  ,submitted = 1, `got_marks`='$marks '  WHERE `std_id` = '$std_id' AND `qsn_id` = '$examId'";
